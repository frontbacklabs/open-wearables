...
| Metric | Unit | Apple | Fitbit | Garmin | Google Health | Health Connect | Oura | Polar | Samsung | Sensorbio | Strava | Suunto | Ultrahuman | Whoop | Withings |
|------|------|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|
| `heart_rate` | bpm | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ |
...
| `withings_metabolic_age` | years | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ |
| `withings_pulse_wave_velocity` | m_per_s | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ |
...
| Field | Apple | Fitbit | Garmin | Google Health | Health Connect | Oura | Polar | Samsung | Sensorbio | Strava | Suunto | Ultrahuman | Whoop | Withings |
|------|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|
| `average_cadence` | ✅ | ❌ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| `average_speed` | ✅ | ❌ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ❌ | ✅ | ✅ | ❌ | ❌ | ❌ |
| `average_watts` | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ❌ | ❌ | ❌ |
...
| Score | Apple | Fitbit | Garmin | Google Health | Health Connect | Oura | Polar | Samsung | Sensorbio | Strava | Suunto | Ultrahuman | Whoop | Withings |
|------|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|
| `activity` | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
| `body_battery` | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| `readiness` | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
...
<Accordion title="Whoop">
  **Integration Method:** OAuth 2.0 (pull + webhook)
  ...
  - Daily step count from the cycle's `step_count` (null when there is no step data, e.g. the device was not worn)
  ...
  - Strain scores: daily (from scored cycles) and per workout
</Accordion>
...
<Accordion title="Ultrahuman">
  **Integration Method:** OAuth 2.0 (pull-based polling)
  ...
  - Continuous 24/7 timeseries: heart rate, HRV (RMSSD), skin temperature, steps
...
<Accordion title="Health Connect (mobile SDK)">
  The `health_connect` provider — data pushed from an Android device. Stored records carry the originating app's name in `source` (e.g. the app that wrote to Health Connect). The Google Health API cloud path is the separate `google_health` provider, below.
  ...
  **Integration Method:** Push-based via Android SDK (no OAuth)
  ...
  - Workout sessions carry duration, type and start/end times, plus whatever aggregates the payload's `statistics` supply (energy, heart rate, distance); workout field coverage is declared from the shared SDK field sets, so a session does not necessarily populate every field listed for it above
...
<Accordion title="Google Health (cloud OAuth)">
  The `google_health` provider — the Google Health API cloud path. Stored records carry the fixed marker `source = "google_health_api"`. All endpoints are under `https://health.googleapis.com/v4/users/me`.
  ...
  **Integration Method:** OAuth 2.0 (cloud pull) + push webhooks (notify-only, trigger a windowed pull)
  ...
  - Workout and sleep field coverage is declared from the shared SDK field sets, so the cloud path does not necessarily populate every field listed for it above
</Accordion>
