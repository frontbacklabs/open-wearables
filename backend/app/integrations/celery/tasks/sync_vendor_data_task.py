    ...
    with SessionLocal() as db:
        try:
            ...
            for connection in connections:
                ...
                primary_user_id = _linked_primary_user_id
                sync_source = (
                ...
                try:
                    ...
                    bind_primary_lease(provider_name, connection.provider_user_id, user_id, shared_token)
                    ...
                    if shared_token and connection.provider_user_id:
                        ...
                        clear_primary_lease()
                        release_primary(
                            provider_name, connection.provider_user_id, user_id, shared_token, scope="pull"
                        )
