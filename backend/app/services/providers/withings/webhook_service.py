...
class WithingsWebhookService(BaseWebhookService):
    ...
    def reconcile_user(self, db: DbSession, user_id: str) -> list[dict[str, Any]]:
    ...
    def sync_user(self, db: DbSession, user_id: str, mode: LiveSyncMode) -> list[dict[str, Any]]:
    ...
    def _list_subscriptions(self, db: DbSession, user_id: str) -> list[WithingsNotifyProfile]:
